  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        pricing: "bg-card/90 backdrop-blur-xl border-border/50 shadow-xl hover:shadow-2xl hover:shadow-primary/10 hover:border-primary/30",
        stat: "bg-card/80 backdrop-blur-sm border-border/50",
      },
    },
    defaultVariants: {
      variant: "default",
